...
export const ActivityTicker = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900 dark:bg-gray-950 text-white py-3 overflow-hidden border-t border-gray-700 dark:border-gray-800 transition-colors">
