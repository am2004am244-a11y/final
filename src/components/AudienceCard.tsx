...
export const AudienceCard = ({ platform, count, subtitle, icon, views, onClick }: AudienceCardProps) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6 cursor-pointer hover:shadow-md dark:hover:shadow-lg transition-all duration-300 hover:border-gray-300 dark:hover:border-gray-600"
    >
